...
TEMPLATE_NAME = "inertia_react"
RAILS_REQUIREMENT = ">= 8.1.0"

TEMPLATE_METADATA = {
  name: "inertia_react",
  description: "Rails app with Inertia.js and React for modern SPA development",
  features: %w[postgresql devcontainer rspec rubocop uuid i18n tailwind vite inertia react kamal solid_queue
...
def show_post_install_message
  ...
  Rails application '#{app_name}' created successfully with Inertia.js + React!
