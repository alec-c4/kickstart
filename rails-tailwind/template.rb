...
def setup_active_storage
  ...
  in_root do
    ...
    gsub_file as_migration_file, /create_table :active_storage_attachments/,
              "create_table :active_storage_attachments, id: :uuid"
    gsub_file as_migration_file, /create_table :active_storage_variant_records/,
              "create_table :active_storage_variant_records, id: :uuid"

    gsub_file as_migration_file, /t\.references :record,(.)* null: false, polymorphic: true, index: false/,
              "t.references :record, null: false, polymorphic: true, index: false, type: :uuid"
    gsub_file as_migration_file, /t\.references :blob,(.)* null: false/, "t.references :blob, null: false, type: :uuid"
    gsub_file as_migration_file, /t\.belongs_to :blob,(.)* index: false/,
