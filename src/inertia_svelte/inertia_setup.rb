# Run Inertia Rails generator with Svelte
# Generator will install Vite automatically and modify application.html.erb
# Options:
# --framework=svelte - Use Svelte (latest version)
...
rails_command "generate inertia:install --framework=svelte --typescript --no-interactive --tailwind --vite --no-example-page --force"
